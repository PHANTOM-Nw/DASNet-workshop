...
# Binary (objection-only) variant: collapse all 9 event classes into a single
# "event" class. Used to sanity-check whether the model architecture can learn
# at all with the tiny 12-sample Czech training set, before attempting fine
# class discrimination.
CATEGORIES = [
    {"id": 1, "name": "event"},
]
_SOURCE_LABELS = [
    "car", "walk", "running", "longboard",
    "fence", "construction", "manipulation", "openclose", "regular",
]
LABEL_TO_CATID = {name: 1 for name in _SOURCE_LABELS}
