...
from torchvision.models.detection.faster_rcnn import FasterRCNN, _default_anchorgen, TwoMLPHead, FastRCNNPredictor
...
__all__ = [
    ...
    "fasterrcnn_resnet50_fpn_t",
    "fasterrcnn_resnet50_fpn_v2_t",
    "fasterrcnn_mobilenet_v3_large_fpn_t",
    "fasterrcnn_mobilenet_v3_large_320_fpn_t",
]
...
class FastRCNN(GeneralizedRCNN):
    """
...
class FasterRCNN_ResNet50_FPN_Weights(WeightsEnum):
    COCO_V1 = Weights(
        url="https://download.pytorch.org/models/fasterrcnn_resnet50_fpn_toco-258fb6c6.pth",
...
class FasterRCNN_ResNet50_FPN_V2_Weights(WeightsEnum):
    COCO_V1 = Weights(
        url="https://download.pytorch.org/models/fasterrcnn_resnet50_fpn_v2_toco-dd69338a.pth",
        transforms=ObjectDetection,
        meta={
            **_COMMON_META,
            "num_params": 43712278,
...
class FasterRCNN_MobileNet_V3_Large_FPN_Weights(WeightsEnum):
    COCO_V1 = Weights(
        url="https://download.pytorch.org/models/fasterrcnn_mobilenet_v3_large_fpn_t-fb6a3cc7.pth",
        transforms=ObjectDetection,
        meta={
            **_COMMON_META,
            "num_params": 19386354,
...
class FasterRCNN_MobileNet_V3_Large_320_FPN_Weights(WeightsEnum):
    COCO_V1 = Weights(
        url="https://download.pytorch.org/models/fasterrcnn_mobilenet_v3_large_320_fpn_t-907ea3f9.pth",
        transforms=ObjectDetection,
        meta={
            **_COMMON_META,
            "num_params": 19386354,
...
def fasterrcnn_resnet50_fpn_t(
    ...
    **kwargs: Any,
    ...
    Example::
        ...
        >>> model = torchvision.models.detection.fasterrcnn_resnet50_fpn_t(weights=FasterRCNN_ResNet50_FPN_Weights.DEFAULT)
        >>> # For training
...
def fasterrcnn_resnet50_fpn_v2_t(
    *,
    ...
    **kwargs: Any,
    ...
    :func:`~torchvision.models.detection.fasterrcnn_resnet50_fpn_t` for more
    details.
...
def fasterrcnn_mobilenet_v3_large_320_fpn_t(
    *,
    ...
    **kwargs: Any,
    ...
    Example::
        ...
        >>> model = torchvision.models.detection.fasterrcnn_mobilenet_v3_large_320_fpn_t(weights=FasterRCNN_MobileNet_V3_Large_320_FPN_Weights.DEFAULT)
        >>> model.eval()
        >>> x = [torch.rand(3, 300, 400), torch.rand(3, 500, 400)]
        >>> predictions = model(x)
...
def fasterrcnn_mobilenet_v3_large_fpn_t(
    *,
    ...
    **kwargs: Any,
    ...
    Example::
        ...
        >>> model = torchvision.models.detection.fasterrcnn_mobilenet_v3_large_fpn_t(weights=FasterRCNN_MobileNet_V3_Large_FPN_Weights.DEFAULT)
        >>> model.eval()
        >>> x = [torch.rand(3, 300, 400), torch.rand(3, 500, 400)]
        >>> predictions = model(x)
